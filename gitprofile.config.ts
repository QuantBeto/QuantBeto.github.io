...
const CONFIG = {
  github: {
    username: 'QuantBeto', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['QuantBeto/BioInformatics', 'QuantBeto/Cool'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  seo: {
    title: 'Portfolio of Gilberto Gonzalez Robles',
    description: '',
    imageURL: '',
  },
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://QuantBeto.github.io',
    phone: '',
